...
export const BOOKING_STATUS_FILTER_TABS: { value: string; label: string; color: string; active: string }[] = [
    ...
    { value: 'EVENT_IN_PROGRESS', label: 'Ongoing', color: 'text-blue-600/70 border-transparent hover:border-blue-300 hover:text-blue-700', active: 'bg-blue-600 text-white border-blue-600 shadow-md shadow-blue-300/30' },
