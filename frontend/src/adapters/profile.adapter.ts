...
export function formToDraft(formData: Record<string, unknown>): ProfileDraft {
  return {
    ...
    photos: {
      ...
      primaryUploadUrl: (formData as any).primaryUploadUrl || null,
      galleryUploadIds: (formData as any).galleryUploadIds || [],
      galleryUploadUrls: (formData as any).galleryUploadUrls || [],
    },
    assets: {
    ...
    partnerPreference: {
      ...
      expectationNoteEn: formData.expectation || null,
...
export function draftToForm(draft: Partial<ProfileDraft>): Record<string, unknown> {
  ...
  return {
    ...
    ...(draft.family || {}),
    ...(draft.assets || {}),
    land: draft.assets?.landEn ?? null,
    otherAssets: draft.assets?.otherAssetsEn ?? null,
    ...(draft.partnerPreference || {}),
    expectation: draft.partnerPreference?.expectationNoteEn ?? null,
    ...
    galleryUploadUrls: draft.photos?.galleryUploadUrls ?? [],
    astrology: {
