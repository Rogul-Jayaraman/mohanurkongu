export const adminLayoutEn = {
    meta: {
      dashboard: {
        title: "Dashboard - Mohanur Kongu Admin",
        desc: "Admin control panel overview",
      },
      settings: {
        title: "Settings - Mohanur Kongu Admin",
    ...
    nav: {
      ...
      userAccounts: "Account Management",
