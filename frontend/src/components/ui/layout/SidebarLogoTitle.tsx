...
interface SidebarLogoTitleProps {
  brandKey?: string;
  taglineKey?: string;
  showClose?: boolean;
  onClose?: () => void;
...
const SidebarLogoTitle: React.FC<SidebarLogoTitleProps> = ({
  brandKey = 'brand',
  taglineKey = 'tagline',
  showClose,
  onClose,
  ...
  return (
    <div className="p-6 md:p-8 flex items-center justify-between gap-3">
      ...
      {showClose && (
        <button
          className="xl:hidden text-gray-500 p-1 hover:text-rosewood hover:rotate-90 transition-all duration-300"
          onClick={onClose}
        >
...
export default SidebarLogoTitle;
