            ...
            <div className="relative h-14">
                ...
                <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                    <button
                        ...
                        className={`text-input-icon transition-all duration-300 flex items-center active:scale-95 ${showPassword ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none group-focus-within:opacity-100 group-focus-within:pointer-events-auto'}`}
