        ...
        {isVerifying && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm">
              <div className="w-4 h-4 border-2 border-rosewood/30 border-t-rosewood rounded-full animate-spin" />
              <span className="text-xs font-bold text-rosewood">{t('common.verifying')}</span>
            </div>
          </div>
        )}
        {isExpired && (
